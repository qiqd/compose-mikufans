...
class AiyifanTest {
  ...
  fun fetchDetail() {
    ...
    val searchResult = aiyifan.fetchSearch("JOJO的奇妙冒险", 1, 10)
  ...
  @Test
  fun fetchPlayInfo() {
    val animeDetail = aiyifan.fetchDetail("/ayf.sbs-vod/95251.html")
  ...
  @Test
  fun fetchSearch() {
    val playInfo = aiyifan.fetchPlayInfo("/ayf.sbs-play/21787-1-1.html")
